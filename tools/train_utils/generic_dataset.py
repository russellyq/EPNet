...
from utils_radar import map_pointcloud_to_image
import copy
from nuscenes.utils.data_classes import Box
from pyquaternion import Quaternion
from nuscenes.utils.geometry_utils import view_points
from pointcloud import compute_box_3d, project_to_image, draw_box_3d
from pointcloud import comput_corners_3d, alpha2rot_y, get_pc_hm
  ...
  def _add_instance(
    ...
    if self.opt.pointcloud:
      ...
      if self.opt.disable_frustum:
        ...
        self.pc_dep_to_hm(ret['pc_hm'], ret['pc_dep'], ann['depth'], bbox, dist_thresh, self.opt)
